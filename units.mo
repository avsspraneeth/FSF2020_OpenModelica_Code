package units
  ...
  type kmol_per_day = Real(final quantity = "MolarFlowRate", final unit = "kmol/d");
  ...
  algorithm
    ...
    annotation(
      Inline = true,
      Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Text(extent = {{-8, 100}, {-100, 54}}, textString = "dram/s"), Text(extent = {{100, -44}, {-10, -100}}, textString = "kg/s")}));
  end from_dram_per_s;
