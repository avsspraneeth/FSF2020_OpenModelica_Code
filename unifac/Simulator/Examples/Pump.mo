...
//Inputs and Specifications
  ...
  extends Modelica.Icons.Example;
    ...
    parameter Integer nop = 8;
    parameter Real xhead[nop] = {200.0, 400, 600.0, 800.0, 1000.0, 1200.0, 1400.0, 1600.0};
    parameter Real yhead[nop] = {13, 12.5, 11.5, 10.5, 9, 6.5, 3.5, .5};
    parameter Real xpower[nop] = {200.0, 400, 600.0, 800.0, 1000.0, 1200.0, 1400.0, 1600.0};
    parameter Real ypower[nop] = {1.5, 1.625, 1.75, 1.8, 1.75, 1.7, 1.6, 1.55};
    parameter Real xeff[nop] = {200.0, 400, 600.0, 800.0, 1000.0, 1200.0, 1400.0, 1600.0};
    parameter Real yeff[nop] = {30, 57, 60, 70, 75, 65, 35, 5};
    //=====================================================================
    //Instantiation of Streams and Blocks
    Simulator.Examples.Pump.ms S1(Nc = Nc, C = C) annotation(
      Placement(visible = true, transformation(origin = {-40, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Simulator.UnitOperations.CentrifugalPumpnew B1(C = C, Nc = Nc, nop = nop, xhead = xhead, yhead = yhead, xpower = xpower, ypower = ypower, xeff = xeff, yeff = yeff, CalcMode = "Curves") annotation(
      Placement(visible = true, transformation(origin = {14, -4}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
    Simulator.Examples.Pump.ms S2(Nc = Nc, C = C) annotation(
...
//Connections
    connect(E1.Out, B1.En) annotation(
      Line(points = {{-10, -30}, {-10, -29}, {14, -29}, {14, -14}}, color = {255, 0, 0}));
    connect(B1.Out, S2.In) annotation(
      Line(points = {{28, 10}, {54, 10}}, color = {0, 70, 70}));
    connect(S1.Out, B1.In) annotation(
      Line(points = {{-30, -2}, {0, -2}}, color = {0, 70, 70}));
//=====================================================================
//Inputs and Specifications
    S1.F_p[1] = 1.65914e07;
    S1.x_pc[1, :] = {1};
